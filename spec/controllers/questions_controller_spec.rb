...
RSpec.describe QuestionsController, type: :controller do
  let(:my_question) { Question.create!(title: "What does it mean?", body: "It doesn't mean anything.") }
  ...
  describe "POST create" do
    it "increases the number of Question by 1" do
      expect{post :create, question: {title: "What does it mean?", body: "It doesn't mean anything."}}.to change(Question,:count).by(1)
    end
    
    it "assigns the new question to @question" do
      post :create, question: {title: "What does it mean?", body: "It doesn't mean anything."}
  ...
  describe "PUT update" do
    it "updates question with expected attributes" do
      new_title = "What does it mean?"
      new_body = "It doesn't mean anything."
